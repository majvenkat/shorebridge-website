...
function HomePage({ go }) {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section style={{ minHeight: "92vh", display: "flex", alignItems: "center", background: "radial-gradient(ellipse at 50% -10%, rgba(14,165,233,0.12) 0%, transparent 60%)", padding: "4rem 1.5rem", position: "relative" }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", width: "100%", position: "relative", zIndex: 1 }}>
          <div style={{ maxWidth: 720 }}>
            ...
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 56 }}>
              ...
              <button onClick={() => go("For Corporates")} style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.15)", color: "#fff", padding: "14px 32px", borderRadius: 10, cursor: "pointer", fontSize: 15, fontWeight: 700 }}>
                Hire Seafarers
              </button>
            </div>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        {submitted ? (
          <div style={{ background: "rgba(16,185,129,0.08)", border: "1px solid rgba(16,185,129,0.25)", borderRadius: 16, padding: "3rem", textAlign: "center" }}>
            ...
            <a href="https://wa.me/919392935499?text=Hello%20ShoreBridge!%20I%20just%20registered." target="_blank" rel="noopener noreferrer"
