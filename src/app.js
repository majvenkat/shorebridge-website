      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <div onClick={() => go("Home")} style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }}>
            <div style={{ width: 38, height: 38, borderRadius: "50%", background: "linear-gradient(135deg, #0ea5e9, #1d4ed8)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, boxShadow: "0 0 16px rgba(14,165,233,0.4)" }}>
              &#9875;
            </div>
            <div>
          ...
          <div style={{ display: "flex", gap: 4, alignItems: "center", flexWrap: "wrap" }}>
            {NAV.map(n => (
              <button key={n} onClick={() => go(n)} style={{
                background: page === n ? "rgba(14,165,233,0.12)" : "transparent",
                border: "none", color: page === n ? C.blue : C.muted,
                padding: "6px 12px", borderRadius: 6, cursor: "pointer",
                fontSize: 13, fontWeight: page === n ? 600 : 400, transition: "all 0.2s"
              }}>{n}</button>
            ))}
            <button onClick={() => go("Contact")} style={{
              background: "linear-gradient(135deg, #0ea5e9, #1d4ed8)", border: "none",
              color: "#fff", padding: "8px 18px", borderRadius: 8, cursor: "pointer",
              fontSize: 13, fontWeight: 700, marginLeft: 8, boxShadow: "0 2px 12px rgba(14,165,233,0.3)"
            }}>Register Now</button>
          </div>
        </div>
      </nav>
      ...
      <footer style={{ background: "#060b18", borderTop: "1px solid rgba(255,255,255,0.06)", padding: "3rem 1.5rem 2rem" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 40, marginBottom: 40 }}>
            ...
            {[
              { title: "Platform", links: ["For Seafarers", "For Corporates", "How It Works", "Replacement Clusters"] },
              ...
              <div key={i}>
                ...
                {col.links.map(l => (
                  <div key={l} onClick={() => go(l.includes("For") || l.includes("How") ? l : l.includes("About") ? "About" : "Contact")}
                    style={{ fontSize: 13, color: C.dim, marginBottom: 10, cursor: "pointer" }}>{l}</div>
                ))}
              </div>
            ))}
          </div>
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.05)", paddingTop: 20, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <div style={{ fontSize: 12, color: C.dim }}>Made with love for India's Seafarers</div>
          </div>
        </div>
      </footer>
    </div>
  ...
  return (
    <div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", width: "100%", position: "relative", zIndex: 1 }}>
          <div style={{ maxWidth: 720 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(14,165,233,0.1)", border: "1px solid rgba(14,165,233,0.25)", borderRadius: 100, padding: "6px 16px", marginBottom: 24 }}>
              ...
              <span style={{ fontSize: 12, color: C.blue, fontWeight: 600, letterSpacing: 1 }}>NOW LAUNCHING IN INDIA</span>
            </div>
            ...
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 56 }}>
              <button onClick={() => go("Contact")} style={{ background: "linear-gradient(135deg, #0ea5e9, #1d4ed8)", border: "none", color: "#fff", padding: "14px 32px", borderRadius: 10, cursor: "pointer", fontSize: 15, fontWeight: 700, boxShadow: "0 4px 24px rgba(14,165,233,0.35)" }}>
                Register as Seafarer
              </button>
              <button onClick={() => go("For Corporates")} style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.15)", color: "#fff", padding: "14px 32px", borderRadius: 10, cursor: "pointer", fontSize: 15, fontWeight: 600 }}>
                Hire Seafarers
              </button>
            </div>
            <div style={{ display: "flex", gap: 40, flexWrap: "wrap" }}>
              {[
                { n: count.toLocaleString("en-IN") + "+", l: "Indian Seafarers" },
                { n: "4-6 Mo", l: "Shore Availability" },
                { n: "21+", l: "Rank Categories" },
                { n: "Free", l: "To Join" },
              ].map(s => (
                <div key={s.l}>
                  <div style={{ fontSize: 26, fontWeight: 800, color: C.blue }}>{s.n}</div>
                  <div style={{ fontSize: 11, color: C.dim, letterSpacing: 1, textTransform: "uppercase", marginTop: 2 }}>{s.l}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section style={{ background: "rgba(239,68,68,0.04)", borderTop: "1px solid rgba(239,68,68,0.1)", borderBottom: "1px solid rgba(239,68,68,0.1)", padding: "2rem 1.5rem", textAlign: "center" }}>
        <p style={{ fontSize: 18, color: C.text, fontWeight: 500, margin: 0 }}>
          <span style={{ color: "#ef4444" }}>9 million man-months</span> of certified maritime talent sits idle every year in India.{" "}
          <span style={{ color: C.blue }}>ShoreBridge changes that.</span>
        </p>
      </section>
      ...
      <section style={{ padding: "5rem 1.5rem" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <div style={{ fontSize: 11, letterSpacing: 4, color: C.blue, textTransform: "uppercase", marginBottom: 8 }}>Simple Process</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 20 }}>
            {[
              ...
              <div key={i} style={{ background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 14, padding: "1.8rem" }}>
                ...
                <div style={{ fontSize: 11, color: C.blue, letterSpacing: 2, marginBottom: 6 }}>{s.n}</div>
      ...
      <section style={{ padding: "4rem 1.5rem", background: "rgba(255,255,255,0.01)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
          <div style={{ background: "rgba(14,165,233,0.05)", border: "1px solid rgba(14,165,233,0.2)", borderRadius: 20, padding: "2.5rem" }}>
            ...
            <p style={{ color: C.muted, fontSize: 14, lineHeight: 1.7, marginBottom: 20 }}>Stop losing income during shore leave. Your maritime skills are worth real money on land. We translate your sea experience to shore employers automatically.</p>
            {["Free to join and register", "AI-matched jobs by rank", "Group health and life insurance", "Replacement cluster — earn annually"].map(b => (
              <div key={b} style={{ display: "flex", gap: 8, marginBottom: 8, fontSize: 13, color: C.muted }}><span style={{ color: C.green }}>checkmark</span>{b}</div>
            ))}
          ...
          <div style={{ background: "rgba(245,158,11,0.05)", border: "1px solid rgba(245,158,11,0.2)", borderRadius: 20, padding: "2.5rem" }}>
            ...
            <p style={{ color: C.muted, fontSize: 14, lineHeight: 1.7, marginBottom: 20 }}>Access India's most disciplined workforce. Safety-trained, process-oriented, available for 4-6 month contracts. Subscribe to a Replacement Cluster for year-round continuity.</p>
            {["Verified INDOS profiles", "Pay 8-12% only on successful hire", "Replacement Cluster continuity", "Oil and gas, EPC, ports, logistics ready"].map(b => (
              <div key={b} style={{ display: "flex", gap: 8, marginBottom: 8, fontSize: 13, color: C.muted }}><span style={{ color: C.gold }}>checkmark</span>{b}</div>
            ))}
      ...
      <section style={{ padding: "4rem 1.5rem" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            <div style={{ fontSize: 11, letterSpacing: 4, color: C.blue, textTransform: "uppercase", marginBottom: 8 }}>Every Rank Has Shore Value</div>
            <h2 style={{ fontSize: 28, fontWeight: 800, color: "#fff", margin: 0 }}>From Master to Motorman — We Place All Ranks</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
            {[
              ["Master / Captain", "Project Director"],["Chief Officer", "Ops Manager"],
              ["2nd / 3rd Officer", "Safety Officer"],["Chief Engineer", "Plant Manager"],
              ["2nd / 3rd Engineer", "Maintenance Engr"],["Electrical Officer ETO", "Automation Engr"],
              ["Bosun", "Site Supervisor"],["AB / OS", "Site Worker / Rigger"],
              ["Motorman / Oiler", "Plant Operator"],["Fitter / Pumpman", "Mechanical Fitter"],
              ["Chief Cook", "Camp Chef / F&B Mgr"],["DP Officer", "Marine Ops Coord"],
            ].map(([sea, shore], i) => (
              <div key={i} style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 10, padding: "1rem" }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: C.blue, marginBottom: 4 }}>Sea: {sea}</div>
                <div style={{ fontSize: 11, color: C.dim }}>Shore: {shore}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: "4rem 1.5rem" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ background: "linear-gradient(135deg, rgba(14,165,233,0.12), rgba(29,78,216,0.12))", border: "1px solid rgba(14,165,233,0.2)", borderRadius: 20, padding: "3rem", textAlign: "center" }}>
            ...
            <button onClick={() => go("Contact")} style={{ background: "linear-gradient(135deg, #0ea5e9, #1d4ed8)", border: "none", color: "#fff", padding: "14px 40px", borderRadius: 10, cursor: "pointer", fontSize: 16, fontWeight: 700, boxShadow: "0 4px 24px rgba(14,165,233,0.35)" }}>
    ...
    <div style={{ padding: "4rem 1.5rem" }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          <div style={{ fontSize: 11, letterSpacing: 4, color: C.blue, textTransform: "uppercase", marginBottom: 8 }}>The Process</div>
          <h1 style={{ fontSize: 36, fontWeight: 800, color: "#fff", marginBottom: 12 }}>How ShoreBridge Works</h1>
          <p style={{ color: C.muted, fontSize: 16 }}>Simple, fast, built for the seafarer life cycle</p>
        </div>
        ...
        <div>
          <h2 style={{ fontSize: 20, fontWeight: 700, color: C.gold, marginBottom: 24 }}>For Corporates</h2>
          {[
            { icon: "🖥", t: "Register Your Company", d: "Create a corporate account on the ShoreBridge web dashboard. Verify with GST number. Access the full verified seafarer talent pool immediately." },
            ...
            { icon: "💬", t: "Interview and Select", d: "Message candidates directly through the platform. Shortlist preferred candidates. Standard shore employment contract template provided." },
            { icon: "checkmark", t: "Confirm and Pay", d: "Confirm the placement. Invoice for 8-12% of CTC generated automatically. Pay only on successful hire — zero upfront cost." },
            { icon: "🔄", t: "Subscribe to a Replacement Cluster", d: "Never lose continuity. Subscribe to a Replacement Cluster — same-background seafarers rotate in when your hire ships out." },
          ].map((s, i) => (
            <div key={i} style={{ display: "flex", gap: 20, marginBottom: 20, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 12, padding: "1.5rem" }}>
              <div style={{ fontSize: 28, flexShrink: 0 }}>{s.icon}</div>
              <div>
  ...
  return (
    <div style={{ padding: "4rem 1.5rem" }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <div style={{ fontSize: 11, letterSpacing: 4, color: C.blue, textTransform: "uppercase", marginBottom: 8 }}>For Seafarers</div>
          <h1 style={{ fontSize: 36, fontWeight: 800, color: "#fff", marginBottom: 12 }}>Your Shore Leave. Your Income.</h1>
          <p style={{ color: C.muted, fontSize: 16, maxWidth: 560, margin: "0 auto" }}>Stop earning zero during your 4-6 months ashore. Your skills are worth good money on land.</p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 48 }}>
          {[
            ...
            { icon: "checkmark", t: "INDOS Verified Badge", d: "Your INDOS verification gives you a trusted badge that shore employers respect. Stand out from unverified candidates instantly." },
            ...
            { icon: "🛡", t: "Group Health Insurance", d: "Negotiate group health and life insurance at 30-40% below individual market rates. Medical cover during shore leave." },
        ...
        <div style={{ background: "rgba(16,185,129,0.05)", border: "1px solid rgba(16,185,129,0.15)", borderRadius: 16, padding: "2rem", marginBottom: 32 }}>
          <h3 style={{ fontSize: 18, fontWeight: 700, color: C.green, marginBottom: 16 }}>What Can You Earn Ashore?</h3>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
            <thead>
              <tr style={{ background: "rgba(16,185,129,0.08)" }}>
                {["Your Rank", "Shore Role", "Monthly Earnings"].map(h => (
                  <th key={h} style={{ padding: "10px 14px", textAlign: "left", color: C.green, fontWeight: 600, borderBottom: "1px solid rgba(16,185,129,0.15)" }}>{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
              {[
                ["Master / Captain", "Project Director / HSE Head", "Rs 1.8L to 3.5L/month"],
                ["Chief Engineer", "Plant Manager / Turnaround Mgr", "Rs 2.0L to 4.0L/month"],
                ["Chief Officer", "Operations / Logistics Manager", "Rs 1.2L to 2.2L/month"],
                ["2nd / 3rd Engineer", "Maintenance Engineer", "Rs 75K to 1.2L/month"],
                ["Electrical Officer ETO", "Automation / Electrical Engineer", "Rs 90K to 1.6L/month"],
                ["Bosun", "Site Supervisor / Foreman", "Rs 35K to 60K/month"],
                ["AB / OS", "Site Worker / Rigger", "Rs 18K to 32K/month"],
                ["Motorman / Oiler", "Plant Operator", "Rs 18K to 32K/month"],
                ["Chief Cook", "Camp Chef / F&B Manager", "Rs 40K to 80K/month"],
              ].map((r, i) => (
                <tr key={i} style={{ borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                  {r.map((c, j) => (
                    <td key={j} style={{ padding: "10px 14px", color: j === 2 ? C.green : C.muted, fontWeight: j === 2 ? 700 : 400 }}>{c}</td>
                  ))}
                </tr>
              ))}
            </tbody>
...
function CorporatesPage({ go }) {
  return (
    <div style={{ padding: "4rem 1.5rem" }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <div style={{ fontSize: 11, letterSpacing: 4, color: C.gold, textTransform: "uppercase", marginBottom: 8 }}>For Corporates and MSMEs</div>
          <h1 style={{ fontSize: 36, fontWeight: 800, color: "#fff", marginBottom: 12 }}>India's Most Disciplined Workforce. Verified.</h1>
          <p style={{ color: C.muted, fontSize: 16, maxWidth: 580, margin: "0 auto" }}>Safety-trained, process-oriented, certified workers available for 4-6 month project contracts.</p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16, marginBottom: 40 }}>
          {[
            { icon: "checkmark", t: "INDOS Verified", d: "Every candidate verified against DG Shipping national registry. Zero fake profiles." },
            { icon: "🎯", t: "Pay on Success Only", d: "8-12% placement fee only when you hire. Zero upfront cost. Zero risk to you." },
            { icon: "🔄", t: "Continuity Guaranteed", d: "Replacement Cluster ensures your project never stalls when a seafarer ships out." },
            { icon: "lightning", t: "Fast Matching", d: "Post a role, get matched candidates within 24 hours. AI-filtered by rank and location." },
        ...
        <div style={{ background: "rgba(245,158,11,0.04)", border: "1px solid rgba(245,158,11,0.15)", borderRadius: 16, padding: "2rem", marginBottom: 32 }}>
          <h3 style={{ fontSize: 18, fontWeight: 700, color: C.gold, marginBottom: 20 }}>Pricing — Simple and Fair</h3>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16 }}>
            {[
              ...
              <div key={i} style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 12, padding: "1.5rem" }}>
                <div style={{ fontSize: 13, color: C.blue, fontWeight: 700, marginBottom: 8 }}>{p.plan}</div>
                <div style={{ fontSize: 22, fontWeight: 800, color: "#fff", marginBottom: 4 }}>{p.price}</div>
                <div style={{ fontSize: 11, color: C.dim, marginBottom: 16 }}>{p.sub}</div>
                {p.features.map(f => (
                  <div key={f} style={{ fontSize: 12, color: C.muted, marginBottom: 6, display: "flex", gap: 6 }}><span style={{ color: C.green }}>+</span>{f}</div>
                ))}
              </div>
            ))}
          </div>
    ...
    <div style={{ padding: "4rem 1.5rem" }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <p style={{ color: C.muted, fontSize: 16, maxWidth: 620, margin: "0 auto", lineHeight: 1.8 }}>ShoreBridge was born from a simple observation: India produces the world's finest seafarers, yet they spend nearly half their working lives ashore — underemployed and undervalued. We are changing that.</p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 40 }}>
          <div style={{ background: "rgba(14,165,233,0.04)", border: "1px solid rgba(14,165,233,0.12)", borderRadius: 16, padding: "2rem" }}>
            ...
            <p style={{ color: C.muted, fontSize: 14, lineHeight: 1.8 }}>To formalise and maximise shore employment for every Indian seafarer — from Master Mariners to Ordinary Seamen — ensuring their world-class skills are recognised, respected, and rewarded ashore.</p>
          </div>
          <div style={{ background: "rgba(16,185,129,0.04)", border: "1px solid rgba(16,185,129,0.12)", borderRadius: 16, padding: "2rem" }}>
            ...
            <p style={{ color: C.muted, fontSize: 14, lineHeight: 1.8 }}>To become the global operating system for seafarer shore employment — connecting 5 million seafarers across India, Philippines, Indonesia, UAE, and beyond to meaningful shore work.</p>
          </div>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 20, marginBottom: 40, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: "2rem" }}>
          {[{ n: "1.8M+", l: "Indian Seafarers" }, { n: "9M", l: "Man-months idle/yr" }, { n: "Rs 0", l: "Shore income today" }, { n: "1st", l: "Platform to solve this" }].map((s, i) => (
            <div key={i} style={{ textAlign: "center" }}>
              <div style={{ fontSize: 28, fontWeight: 800, color: C.blue }}>{s.n}</div>
  ...
  return (
    <div style={{ padding: "4rem 1.5rem" }}>
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <div style={{ fontSize: 11, letterSpacing: 4, color: C.blue, textTransform: "uppercase", marginBottom: 8 }}>Early Access</div>
          <h1 style={{ fontSize: 36, fontWeight: 800, color: "#fff", marginBottom: 12 }}>Register Now</h1>
          <p style={{ color: C.muted, fontSize: 15 }}>First 5,000 seafarers get 12 months Premium free. First 20 corporates get 2 hires free.</p>
        </div>
        {submitted ? (
          <div style={{ background: "rgba(16,185,129,0.08)", border: "1px solid rgba(16,185,129,0.25)", borderRadius: 16, padding: "3rem", textAlign: "center" }}>
            ...
            <h3 style={{ fontSize: 22, fontWeight: 700, color: C.green, marginBottom: 8 }}>You're Registered!</h3>
            <p style={{ color: C.muted, fontSize: 14 }}>Welcome aboard, {formData.name}. We will WhatsApp you on {formData.mobile} when the platform launches in your area.</p>
          </div>
        ) : (
          <div style={{ background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: "2.5rem" }}>
            <div style={{ display: "flex", gap: 8, marginBottom: 28, background: "rgba(255,255,255,0.04)", borderRadius: 10, padding: 4 }}>
              {["seafarer", "corporate"].map(t => (
                <button key={t} onClick={() => setFormData(f => ({ ...f, type: t }))} style={{
                  flex: 1, padding: "10px", borderRadius: 8, border: "none", cursor: "pointer",
                  background: formData.type === t ? (t === "seafarer" ? "linear-gradient(135deg, #0ea5e9, #1d4ed8)" : "linear-gradient(135deg, #f59e0b, #d97706)") : "transparent",
                  color: formData.type === t ? "#fff" : C.dim, fontWeight: 700, fontSize: 14
                }}>{t === "seafarer" ? "I am a Seafarer" : "I am a Corporate"}</button>
              ))}
            </div>
            {[
              ...
              { key: "rank", label: formData.type === "seafarer" ? "Your Rank" : "Company Name", ph: formData.type === "seafarer" ? "e.g. Chief Engineer, AB, Master" : "Your company name" },
            ].map(f => (
            ...
            <button onClick={handleSubmit} style={{
              ...
              background: formData.type === "seafarer" ? "linear-gradient(135deg, #0ea5e9, #1d4ed8)" : "linear-gradient(135deg, #f59e0b, #d97706)",
              border: "none", color: "#fff", borderRadius: 10, cursor: "pointer", fontSize: 15, fontWeight: 700, marginTop: 8
            }}>
              {formData.type === "seafarer" ? "Register as Seafarer — Free" : "Register as Corporate — First 2 Hires Free"}
            </button>
            <p style={{ textAlign: "center", fontSize: 11, color: C.dim, marginTop: 16 }}>No spam. No credit card. We will WhatsApp you when we launch.</p>
          </div>
        )}
        <div style={{ marginTop: 40, display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16 }}>
          {[
            { icon: "email", label: "Email", val: "hello@shorebridge.in" },
            { icon: "whatsapp", label: "WhatsApp", val: "+91 XXXXX XXXXX" },
            { icon: "web", label: "Website", val: "www.shorebridge.in" },
          ].map(c => (
            <div key={c.label} style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 10, padding: "1rem", textAlign: "center" }}>
              <div style={{ fontSize: 11, color: C.dim, marginBottom: 4 }}>{c.label}</div>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 600 }}>{c.val}</div>
            </div>
          ))}
        </div>
      </div>
